...
{
	// Check if the install/ directory exists, redirect if so
	header("location: install/");
}
elseif(file_exists("update/index.php"))
{
	// Check if the update/ directory exists, redirect if so
...
include('core/phpseclib3/Math/BigInteger.php');
include('core/security/Client.php');
include('core/security/UserClient.php');
